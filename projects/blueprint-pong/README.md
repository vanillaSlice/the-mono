...
[![Build Status](https://img.shields.io/github/actions/workflow/status/vanillaSlice/the-mono/blueprint-pong.yml?branch=main)](https://github.com/vanillaSlice/the-mono/actions?query=workflow%3ABlueprint-Pong+branch%3Amain)
